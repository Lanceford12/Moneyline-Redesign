...
WebUI.click(findTestObject('Profile settings/label_Language'))

WebUI.selectOptionByIndex(findTestObject('Profile settings/Language arrow list box'), 0)

WebUI.click(findTestObject('Profile settings/Change language button'))

WebUI.click(findTestObject('Profile settings/Yes to change language button'))
