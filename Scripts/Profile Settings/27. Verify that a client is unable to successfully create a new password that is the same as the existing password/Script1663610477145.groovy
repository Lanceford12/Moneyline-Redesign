...
WebUI.setText(findTestObject('Object Repository/Profile settings/input_New Password'), 'EXV/7fvP')

WebUI.setText(findTestObject('Object Repository/Profile settings/input_Confirm Password'), 'EXV/7fvP')
