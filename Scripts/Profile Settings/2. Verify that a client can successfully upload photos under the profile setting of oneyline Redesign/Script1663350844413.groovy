...
WebUI.click(findTestObject('Object Repository/Profile settings/label_Add Photo'))

WebUI.uploadFile(findTestObject('Profile settings/label_Add Photo'), 'C:\\Users\\lwynter\\Pictures\\test case 1(4).PNG')
