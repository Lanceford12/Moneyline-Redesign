...
WebUI.click(findTestObject('Alerts and Messages/Delete icon for messages'))

WebUI.click(findTestObject('Alerts and Messages/Select no to delete message(pop up )'))
