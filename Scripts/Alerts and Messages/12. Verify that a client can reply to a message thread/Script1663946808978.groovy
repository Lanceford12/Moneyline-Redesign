...
WebUI.click(findTestObject('Alerts and Messages/Reply to the first message button'))

WebUI.setText(findTestObject('Alerts and Messages/reply text area'), 'thank you')

WebUI.click(findTestObject('Alerts and Messages/reply send button'))
